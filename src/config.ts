export default {
  ...
  TypeWriteList: [
    '天上的星光漫漫，那是被夸父打碎的太阳.',
    "The starlight in the sky is vast and boundless, which is the sun shattered by Kuafu.",
  ],
  // 网站创建时间
  ...
  HomeBanner: {
    ...
    PageHeight: '28.88rem',
    // 背景
    background: "url('https://image.blowswind.cn/v2/G7LTuLu.jpeg') no-repeat center 60%/cover",
  },
  // 博客主题配置
  Theme: {
    // 颜色请用 16 进制颜色码
  ...
  DNSOptimization: [
    ...
    'https://image.blowswind.cn',
    'https://music-api.blowswind.cn',
    'https://waline.blowswind.cn'
  ],
  // 博客音乐组件解析接口
